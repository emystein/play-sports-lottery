...
trait TestObjects {
  ...
  val brasilSwitzerlandMatch = new MatchSchedule("Brasil", "Switzerland", 2018, 6, 17)
  val brasilCostaRicaMatch = new MatchSchedule("Brasil", "Costa Rica", 2018, 6, 22)
  val serbiaSwitzerlandMatch = new MatchSchedule("Serbia", "Switzerland", 2018, 6, 22)
  val serbiaBrasilMatch = new MatchSchedule("Serbia", "Brasil", 2018, 6, 27)
